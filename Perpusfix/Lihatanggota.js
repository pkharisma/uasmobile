...
export default class Lihatanggota extends React.Component{
    constructor(props) {
        super(props); 
        this.state = {
          data: []
    ...
    componentDidMount(){
    axios.get('https://putukharisma.000webhostapp.com/sistemperpustakaan/getAnggota.php?kode_anggota=')
    .then((response)=>{
      ...
      <FlatList
                    ...
                    renderItem={({item}) => (
                        <View>
                            ...
                            <Text>ID anggota : {item.kode_anggota}</Text>
